...
# 2. Printing out list of `ingredients`
# ------------------------
...
# 3. Asking the user if he got all ingredients
# ------------------------
...
# 7. Defining `ask_if_ready` for step method
# ------------------------
...
# 8. Iterating to each of the steps
# ------------------------
